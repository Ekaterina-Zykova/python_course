...
def test_homework_result_with_type_error():
    ...
    assert str(exc.value) == "You gave a not Homework object"


def test_homework_result_without_error():
    student = Student("Roman", "Petrov")
    homework = Homework("Learn OOP", 1)
    hw_result = HomeworkResult(student, homework, solution)
...
def test_do_homework_with_error():
    ...
    assert str(exc.value) == "You are late"
...
def test_homework_done_have_only_unique_solutions():
    ...
    student = Student("Roman", "Petrov")
    homework = Homework("Learn OOP", 5)
    done_homework = HomeworkResult(student, homework, solution)
...
def test_reset_results():
    ...
    hw1_result = HomeworkResult(student, homework_1, solution)
